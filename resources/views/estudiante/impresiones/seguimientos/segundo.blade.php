...
<body>
    ...
    <table class="tabla">
        <tr>
            ...
            <th style="width: 33.33%; height: 30px;  vertical-align: bottom;" class="cuadro dato">{{ \Carbon\Carbon::parse($segundo->califico_externo)->format('Y-m-d') }}  <br> Fecha de Evaluación</th>
        </tr>
    </table>
    ...
    <table class="tabla">
        <tr>
            ...
            <th style="width: 33.33%; height: 30px;  vertical-align: bottom;" class="cuadro dato">{{ \Carbon\Carbon::parse($segundo->califico_interno)->format('Y-m-d') }} <br> Fecha de Evaluación </th>
        </tr>
    </table>
