<template>
  <AppLayout>
    <div class="bodydiv">
      ...
      <div class="centro">
        <div class="form-card">
          <form @submit.prevent="actualizarAsesor" class="formulario">
...
// Formulario reactivo con los datos del asesor
const form = ref({
  nombre: props.asesor.nombre || '',
  apellido_paterno: props.asesor.apellido_paterno || '',
  apellido_materno: props.asesor.apellido_materno || '',
  correo_electronico: props.asesor.correo_electronico || '',
  profesion: props.asesor.profesion || '',
  carrera: props.asesor.carrera || '',
  numero_cedula: props.asesor.numero_cedula || ''
})
...
const actualizarAsesor = () => {
  ...
  router.put(route('asesores.update', props.asesor.id), form.value, {
    preserveScroll: true,
    onSuccess: () => {
      Swal.fire({
        icon: 'success',
        title: '¡Actualizado!',
        text: 'El asesor ha sido actualizado correctamente',
    ...
    onError: (errors) => {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'No se pudo actualizar el asesor. Verifica los campos.',
        confirmButtonText: 'OK'
      })
    },
    onFinish: () => {
