    ...
    <div class="bodydiv">
      <div class="horizontal">
        <p class="subtitulo">
          ...
          Actualizar Asesor Externo
        </p>
      </div>

      <div class="centro">
        <div class="form-card">
          <form @submit.prevent="actualizarAsesorExterno" class="formulario">
            ...
            <div class="form-group">
              ...
              <small class="help-text">Este correo se usa para iniciar sesión en el sistema</small>
            </div>
            ...
            <div class="info-card">
              ...
              <div class="info-text">
                ...
                <ul>
                  <li>Si cambias el correo electrónico, el asesor deberá usar el nuevo correo para iniciar sesión</li>
                  <li>La contraseña no se modifica con este formulario</li>
            ...
            <div class="botones-container">
              ...
              >
                ...
                {{ cargando ? 'Actualizando...' : 'Actualizar Asesor' }}
              </button>
...
// Formulario reactivo con los datos del asesor externo
const form = ref({
  titulo: props.externo.titulo || '',
  nombre: props.externo.nombre || '',
  apellido_paterno: props.externo.apellido_paterno || '',
  apellido_materno: props.externo.apellido_materno || '',
  correo_electronico: props.externo.correo_electronico || '',
  puesto: props.externo.puesto || ''
})
...
const actualizarAsesorExterno = () => {
  ...
  router.put(route('externos.update', props.externo.id), form.value, {
    preserveScroll: true,
    onSuccess: () => {
      Swal.fire({
        icon: 'success',
        title: '¡Actualizado!',
        text: 'El asesor externo ha sido actualizado correctamente',
    ...
    onError: (errors) => {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: Object.values(errors)[0] || 'No se pudo actualizar el asesor externo. Verifica los campos.',
        confirmButtonText: 'OK'
      })
    },
    onFinish: () => {
