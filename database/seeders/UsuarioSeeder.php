...
class UsuarioSeeder extends Seeder
{
    ...
    {
        $nuevo = new Usuario();
        $nuevo->nombre_usuario = "JorgeOctavio@tuxtla.tecnm.mx"; //los nombre_usuario son los correos de los usuarios
        ...
        $nuevo = new Usuario();
        $nuevo->nombre_usuario = "francisco.rm@tuxtla.tecnm.mx";
        $nuevo->contraseña = Hash::make('1234');
        $nuevo->usa_id=6;
        ...
        $nuevo = new Usuario();
        $nuevo->nombre_usuario = "TEST@tuxtla.tecnm.mx";
        $nuevo->contraseña = Hash::make('1234');
        $nuevo->usa_id=3;
        $nuevo->usa_type = "App\Models\Coordinador";
        $nuevo->save();
